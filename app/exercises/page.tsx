    ...
    return (
      <div className="min-h-screen w-full bg-gradient-to-br from-blue-100 to-purple-100 pb-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-3">Exercises</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            The Exercise page hosts your prescribed therapeutic exercises, chosen to enhance range of motion and maximize your recovery.
          </p>
        </div>
