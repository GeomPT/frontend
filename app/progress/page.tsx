  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-100 to-purple-100 pb-8">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-800 mb-3">Assess</h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          The Assess page lets you evaluate your range of motion and
          recovery progress through a variety of mobility assessments.
        </p>
      </div>
